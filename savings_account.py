...
def create_savings_account(balance, interest_rate, months):
    ...
    # ADD YOUR CODE HERE
    updated_balance = account_instance.balance + interest_on_balance
    ...
    # ADD YOUR CODE HERE
    account_instance.set_interest(interest_on_balance)

    # Return the updated balance and interest earned.
    #return  # ADD YOUR CODE HERE
    return (updated_balance, interest_on_balance)
